...
```azurecli
az deployment sub create --name 'deploy-elven-experts-live-nl-2026-wif-bootstrap' --location norwayeast --template-file main.bicep
```
...
```azurecli
az stack sub create --location NorwayEast --name "stack-elven-experts-live-nl-2026-wif-bootstrap" --template-file .\main.bicep --deny-settings-mode none --action-on-unmanage deleteResources

az stack sub create --location NorwayEast --name "stack-elven-experts-live-nl-2026-wif-bootstrap" --template-file .\main.bicep --parameters SOMEOPTIONALPARAMETER=false --deny-settings-mode none --action-on-unmanage deleteResources
```
